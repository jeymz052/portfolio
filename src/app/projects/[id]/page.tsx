          ...
          <div className="relative z-10 p-8 lg:p-16 flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-6">
              <div className="flex flex-wrap gap-3">
                ...
                <Badge
                  variant="secondary"
                  className="bg-red-950/20 text-blue-400 hover:bg-black border-red-900/30 px-3 py-1 font-bold tracking-wider"
                >
                  {project.role}
                </Badge>
              </div>
              ...
              <div className="flex flex-wrap gap-4 mt-4">
                ...
                {project.code && (
                  <Link href={project.code} target="_blank">
                    <Button
                      variant="outline"
                      className="border-white/10 bg-white/5 hover:bg-red-950/20 hover:text-blue-500 hover:border-blue-500/30 text-white px-8 py-6 text-lg rounded-xl transition-all hover:scale-105 active:scale-95 flex gap-2 font-bold uppercase tracking-widest"
                    >
                ...
                <div className="mt-4">
                  <Link href="/#contact" className="w-full">
                    <Button className="w-full bg-blue-600/10 border border-blue-600/20 hover:bg-blue-600 hover:text-white py-6 rounded-xl text-blue-500 font-bold uppercase tracking-widest text-xs transition-all duration-300 group flex gap-2 overflow-hidden relative">
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-red-900 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
