        ...
        <div className="order-2 lg:order-1 flex flex-col items-start gap-8">
          <div className="flex flex-col gap-4">
            ...
            <p className="hero-heading text-lg md:text-xl text-slate-400 max-w-xl leading-relaxed font-medium">
              ...
              applications and much faster and smoother funnels.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="hero-cta flex flex-wrap gap-4">
              <Link
                href="/#contact"
                className="group relative px-8 py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-900 text-white font-bold uppercase tracking-wider overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(59,130,246,0.3)]"
              >
                ...
                <code className="font-mono text-xs md:text-sm lg:text-base leading-relaxed">
                  ...
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-blue-300">'Fullstack & ML'</span>,
                    </p>
                  </div>
                  <div className="flex gap-4">
