        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8 order-2 lg:order-1">
            ...
            <div className="flex flex-wrap gap-8 items-center mt-4">
              ...
              <div className="w-[1px] h-10 bg-white/10" />
              <div className="flex flex-col">
                <span className="text-3xl font-black text-white">NC II</span>
                <span className="text-xs text-slate-500 uppercase tracking-widest font-bold">
                  TESDA Certified
                </span>
              </div>
          ...
          <div className="lg:col-span-5 order-1 lg:order-2">
            ...
            >
              <div className="relative group">
                ...
                <div className="relative aspect-[4/5] rounded-2xl overflow-hidden border-2 border-white/10 shadow-[0_0_50px_rgba(59,130,246,0.15)] bg-white">
                  <Image
                    src={personalData.profile}
                    fill
                    alt={personalData.name}
                    className="object-cover object-center scale-110 transition-all duration-1000 group-hover:scale-125"
